...
public class PlayerTest {
    ...
    public void test_PlayOutOfTurnCards() {
        ...
        player.receiveCard(1);
        player.playCard(1, Integer.valueOf(1));
    ...
    public void test_PlayNotInHandCards() {
        Player p = new Player();
        p.startTurn();
        p.playCard(1, Integer.valueOf(1));
    ...
    public void test_PlayBlueCards() {
        ...
        player.receiveCard(2);
        player.playCard(2, Integer.valueOf(1));
        assertTrue(player.getNumberOfBlueCards() == 1);
        assertTrue(player.getNumberOfHandCards() == 0);
    ...
    public void test_PlayGunCards() {
        ...
        player.playCard(4, Integer.valueOf(1));
        assertTrue(player.getRange() == 5);
        player.playCard(3, Integer.valueOf(1));
        assertTrue(player.getRange() == 4);

        player.receiveCard(5);
        player.playCard(5, Integer.valueOf(1));
        assertTrue(player.getRange() == 1);
        assertTrue(player.getNumberOfBlueCards() == 1);
        assertTrue(player.getNumberOfHandCards() == 0);
    }
    ...
    public void test_Scope() {
        ...
        player.playCard(1, Integer.valueOf(1));
        player.playCard(78, Integer.valueOf(1));
    ...
    public void test_LivesBeersSaloon() {
        ...
        player.playCard(46, Integer.valueOf(1));
        assertTrue(player.test_call.compareTo("drinkBeer") == 0);

        player.receiveCard(71);
        player.playCard(71, Integer.valueOf(1));
    ...
    public void test_ZapInRange() {
        ...
        p.startTurn();
        p.receiveCard(20);
        p.playCard(20, Integer.valueOf(1));
    ...
    public void test_ZapOutOfRange() {
        ...
        p.startTurn();
        p.receiveCard(21);
        p.playCard(21, Integer.valueOf(1));
    ...
    public void test_ZapTwice() {
        ...
        p.receiveCard(22);
        p.playCard(22, Integer.valueOf(1));
    ...
    public void test_Missed() {
        ...
        p.startTurn();
        p.receiveCard(35);
        p.playCard(35, Integer.valueOf(1));
    ...
    public void test_PanicInRange() {
        ...
        p.startTurn();
        p.receiveCard(52);
        p.playCard(52, Integer.valueOf(1));
    ...
    public void test_PanicOutOfRange() {
        ...
        p.receiveCard(78);
        p.playCard(78, Integer.valueOf(1));
        p.playCard(52, Integer.valueOf(1));
        assertTrue(p.test_call.compareTo("panicOpponent") == 0);
    }
    ...
    public void test_CatBalou() {
        ...
        p.startTurn();
        p.receiveCard(56);
        p.playCard(56, Integer.valueOf(1));
    ...
    public void test_StagecoachWellsFargo() {
        ...
        p.receiveCard(60);
        p.receiveCard(62);
        p.playCard(60, Integer.valueOf(1));
        assertTrue(p.test_call.compareTo("drawCards") == 0);
        p.playCard(62, Integer.valueOf(1));
        assertTrue(p.test_call.compareTo("drawCards") == 0);
    ...
    public void test_Gatling() {
        ...
        p.startTurn();
        p.receiveCard(63);
        p.playCard(63, Integer.valueOf(1));
    ...
    public void test_Duel() {
        ...
        p.startTurn();
        p.receiveCard(64);
        p.playCard(64, Integer.valueOf(1));
    ...
    public void test_Aliens() {
        ...
        p.startTurn();
        p.receiveCard(67);
        p.playCard(67, Integer.valueOf(1));
    ...
    public void test_GeneralStore() {
        ...
        p.startTurn();
        p.receiveCard(69);
        p.playCard(69, Integer.valueOf(1));
    ...
    public void test_JailSheriff() {
        ...
        p.startTurn();
        p.receiveCard(72);
        p.playCard(72, Integer.valueOf(1));
    ...
    public void test_Dynamite() {
        ...
        p.startTurn();
        p.receiveCard(75);
        p.playCard(75, Integer.valueOf(1));
    ...
    public void test_Barrel() {
        ...
        p.startTurn();
        p.receiveCard(76);
        p.playCard(76, Integer.valueOf(1));
        assertTrue(p.test_call.compareTo("blue card") == 0);
        assertTrue(p.getNumberOfBlueCards() == 1);
    }
    ...
    public void test_Mustang() {
        ...
        p.startTurn();
        p.receiveCard(79);
        p.playCard(79, Integer.valueOf(1));
        assertTrue(p.test_call.compareTo("blue card") == 0);
        assertTrue(p.getNumberOfBlueCards() == 1);
    }
